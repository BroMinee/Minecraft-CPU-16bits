...
# decrease by 1 the value in memory
scoreboard players remove #opcode_2 Computer 1

scoreboard players operation #opcode_2 Computer %= 256 FixedValue

execute if score goto_video Computer matches 512..5429 run scoreboard players operation #write_video Computer = #opcode_2 Computer
