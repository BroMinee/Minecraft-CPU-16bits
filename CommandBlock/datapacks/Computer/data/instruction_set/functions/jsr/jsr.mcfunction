...
scoreboard players remove PC Computer 1

scoreboard players operation #byte0 Computer = PC Computer
scoreboard players operation #byte1 Computer = PC Computer
scoreboard players operation #byte2 Computer = PC Computer
scoreboard players operation #byte3 Computer = PC Computer

scoreboard players operation #byte3 Computer /= 4096 FixedValue
scoreboard players operation #byte2 Computer %= 4096 FixedValue

scoreboard players operation #byte2 Computer /= 256 FixedValue
scoreboard players operation #byte1 Computer %= 256 FixedValue

scoreboard players operation #byte1 Computer /= 16 FixedValue
scoreboard players operation #byte0 Computer %= 16 FixedValue

execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 0 run setblock ~ ~-1 ~ minecraft:white_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 1 run setblock ~ ~-1 ~ minecraft:orange_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 2 run setblock ~ ~-1 ~ minecraft:magenta_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 3 run setblock ~ ~-1 ~ minecraft:light_blue_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 4 run setblock ~ ~-1 ~ minecraft:yellow_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 5 run setblock ~ ~-1 ~ minecraft:lime_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 6 run setblock ~ ~-1 ~ minecraft:pink_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 7 run setblock ~ ~-1 ~ minecraft:gray_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 8 run setblock ~ ~-1 ~ minecraft:light_gray_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 9 run setblock ~ ~-1 ~ minecraft:cyan_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 10 run setblock ~ ~-1 ~ minecraft:purple_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 11 run setblock ~ ~-1 ~ minecraft:blue_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 12 run setblock ~ ~-1 ~ minecraft:brown_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 13 run setblock ~ ~-1 ~ minecraft:green_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 14 run setblock ~ ~-1 ~ minecraft:red_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte3 Computer matches 15 run setblock ~ ~-1 ~ minecraft:black_concrete

execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 0 run setblock ~ ~-2 ~ minecraft:white_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 1 run setblock ~ ~-2 ~ minecraft:orange_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 2 run setblock ~ ~-2 ~ minecraft:magenta_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 3 run setblock ~ ~-2 ~ minecraft:light_blue_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 4 run setblock ~ ~-2 ~ minecraft:yellow_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 5 run setblock ~ ~-2 ~ minecraft:lime_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 6 run setblock ~ ~-2 ~ minecraft:pink_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 7 run setblock ~ ~-2 ~ minecraft:gray_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 8 run setblock ~ ~-2 ~ minecraft:light_gray_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 9 run setblock ~ ~-2 ~ minecraft:cyan_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 10 run setblock ~ ~-2 ~ minecraft:purple_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 11 run setblock ~ ~-2 ~ minecraft:blue_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 12 run setblock ~ ~-2 ~ minecraft:brown_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 13 run setblock ~ ~-2 ~ minecraft:green_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 14 run setblock ~ ~-2 ~ minecraft:red_concrete
execute as @e[type=armor_stand,limit=1,tag=WRITE] at @s run execute if score #byte2 Computer matches 15 run setblock ~ ~-2 ~ minecraft:black_concrete
...
scoreboard players reset #byte2 Computer
scoreboard players reset #byte3 Computer