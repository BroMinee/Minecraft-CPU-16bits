...
execute if score goto_video Computer matches 512..5429 run scoreboard players operation #write_video Computer = Y Computer
...
scoreboard players operation #byte0 Computer = Y Computer
scoreboard players operation #byte1 Computer = Y Computer
