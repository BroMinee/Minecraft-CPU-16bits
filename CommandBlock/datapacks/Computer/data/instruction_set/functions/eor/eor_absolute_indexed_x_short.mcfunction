...
execute if score #b0.0 Computer matches 0 run execute if score #b0.1 Computer matches 1 run scoreboard players add A Computer 1
execute if score #b1.0 Computer matches 0 run execute if score #b1.1 Computer matches 1 run scoreboard players add A Computer 2
execute if score #b2.0 Computer matches 0 run execute if score #b2.1 Computer matches 1 run scoreboard players add A Computer 4
execute if score #b3.0 Computer matches 0 run execute if score #b3.1 Computer matches 1 run scoreboard players add A Computer 8
execute if score #b4.0 Computer matches 0 run execute if score #b4.1 Computer matches 1 run scoreboard players add A Computer 16
execute if score #b5.0 Computer matches 0 run execute if score #b5.1 Computer matches 1 run scoreboard players add A Computer 32
execute if score #b6.0 Computer matches 0 run execute if score #b6.1 Computer matches 1 run scoreboard players add A Computer 64
execute if score #b7.0 Computer matches 0 run execute if score #b7.1 Computer matches 1 run scoreboard players add A Computer 128

execute if score #b0.0 Computer matches 1 run execute if score #b0.1 Computer matches 0 run scoreboard players add A Computer 1
execute if score #b1.0 Computer matches 1 run execute if score #b1.1 Computer matches 0 run scoreboard players add A Computer 2
execute if score #b2.0 Computer matches 1 run execute if score #b2.1 Computer matches 0 run scoreboard players add A Computer 4
execute if score #b3.0 Computer matches 1 run execute if score #b3.1 Computer matches 0 run scoreboard players add A Computer 8
execute if score #b4.0 Computer matches 1 run execute if score #b4.1 Computer matches 0 run scoreboard players add A Computer 16
execute if score #b5.0 Computer matches 1 run execute if score #b5.1 Computer matches 0 run scoreboard players add A Computer 32
execute if score #b6.0 Computer matches 1 run execute if score #b6.1 Computer matches 0 run scoreboard players add A Computer 64
execute if score #b7.0 Computer matches 1 run execute if score #b7.1 Computer matches 0 run scoreboard players add A Computer 128

tellraw @a[tag=debug] ["    ",{"score":{"name":"#tmp","objective":"Computer"}}," XOR ",{"score":{"name":"#opcode_2","objective":"Computer"}},"=",{"score":{"name":"A","objective":"Computer"}}]
