...
scoreboard players set Z Computer 1

execute if score #b0.0 Computer matches 1 run execute if score #b0.1 Computer matches 1 run scoreboard players set Z Computer 0

execute if score #b1.0 Computer matches 1 run execute if score #b1.1 Computer matches 1 run scoreboard players set Z Computer 0

execute if score #b2.0 Computer matches 1 run execute if score #b2.1 Computer matches 1 run scoreboard players set Z Computer 0

execute if score #b3.0 Computer matches 1 run execute if score #b3.1 Computer matches 1 run scoreboard players set Z Computer 0

execute if score #b4.0 Computer matches 1 run execute if score #b4.1 Computer matches 1 run scoreboard players set Z Computer 0

execute if score #b5.0 Computer matches 1 run execute if score #b5.1 Computer matches 1 run scoreboard players set Z Computer 0

execute if score #b6.0 Computer matches 1 run execute if score #b6.1 Computer matches 1 run scoreboard players set Z Computer 0

execute if score #b7.0 Computer matches 1 run execute if score #b7.1 Computer matches 1 run scoreboard players set Z Computer 0

tellraw @a[tag=debug] ["    BIT : ",{"score":{"name":"A","objective":"Computer"}}," AND ",{"score":{"name":"#opcode_2","objective":"Computer"}},"=",{"score":{"name":"A","objective":"Computer"}}]

# update N FLAGS
scoreboard players operation N Computer = #b7.1 Computer

# update V FLAGS
scoreboard players operation V Computer = #b6.1 Computer
