...
scoreboard players operation #byte0 Computer = C Computer
execute if score Z Computer matches 1 run scoreboard players add #byte0 Computer 2
execute if score I Computer matches 1 run scoreboard players add #byte0 Computer 4
execute if score D Computer matches 1 run scoreboard players add #byte0 Computer 8

scoreboard players operation #byte1 Computer = B Computer
# flags 3 always = 1
scoreboard players add #byte1 Computer 2
execute if score V Computer matches 1 run scoreboard players add #byte1 Computer 4
execute if score N Computer matches 1 run scoreboard players add #byte1 Computer 8
